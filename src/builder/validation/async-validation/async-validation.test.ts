...
describe('AsyncValidation', () => {
    ...
    beforeEach(() => {
        asyncValidation = new AsyncValidation<TestModel>(false, validationRules as ValidationRule<TestModel, unknown, unknown>[]);
    });
    ...
    it('should stop at first invalid rule in failFast mode', async () => {
        asyncValidation = new AsyncValidation<TestModel>(true, validationRules  as ValidationRule<TestModel, unknown, unknown>[]);
