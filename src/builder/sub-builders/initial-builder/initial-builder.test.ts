...
describe('InitialBuilder', () => {
    ...
    test('forField adds a new rule', () => {
        const initialBuilder = new InitialBuilder<TestModel, unknown, unknown, false>(sharedState);
        const forFieldAddedBuilder = initialBuilder.forField('field1', model => model.field1);

        // Assuming you have a way to access the internal state of ForFieldAddedBuilder
    ...
    test('forField sets currentFieldStartIndex', () => {
        const builder = new InitialBuilder<TestModel, unknown, unknown, false>(sharedState);
